...
export default function NewsCard({ article }: { article: Article }) {
    ...
    return (
        <div className="group relative h-full flex flex-col bg-white/[0.03] border border-white/10 rounded-2xl overflow-hidden backdrop-blur-md transition-all duration-300 hover:border-brand-sand/30 hover:bg-white/[0.05] hover:-translate-y-1">
            {/* ── Image ── */}
