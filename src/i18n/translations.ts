...
export const translations: Record<Lang, Record<string, string>> = {
    en: {
        ...
        'contact.product.socialGraphics': 'Social Media Graphics — from €69 (10 graphics)',
        'contact.product.socialStarter': 'Marketing Starter — from €250/mo',
        'contact.product.socialPro': 'Marketing Pro + Ads — from €399/mo',
    ...
    sk: {
        ...
        'contact.product.socialGraphics': 'Grafika pre sociálne siete — od €69 (10 grafík)',
        'contact.product.socialStarter': 'Marketing Starter — od €250/mes',
        'contact.product.socialPro': 'Marketing Pro + Ads — od €399/mes',
    ...
    cs: {
        ...
        'contact.product.logoBasic': 'Logo Basic — od €99',
        'contact.product.logoBrand': 'Logo + Brand — od €229',
        'contact.product.socialGraphics': 'Grafika pro sociální sítě — od €69 (10 grafik)',
        'contact.product.socialStarter': 'Marketing Starter — od €250/měs',
        'contact.product.socialPro': 'Marketing Pro + Ads — od €399/měs',
