...
export const translations: Record<Lang, Record<string, string>> = {
    en: {
        ...
        'contact.projectType.web': 'New website or e-shop',
        'contact.projectType.landing': 'Simple presentation page',
        'contact.projectType.chatbot': 'Chatbot for my website',
    ...
    sk: {
        ...
        'contact.projectType.web': 'Nový web alebo e-shop',
        'contact.projectType.landing': 'Jednoduchá prezentačná stránka',
        'contact.projectType.chatbot': 'Chatbot pre môj web',
    ...
    cs: {
        ...
        'contact.projectType.web': 'Nový web nebo e-shop',
        'contact.projectType.landing': 'Jednoduchá prezentační stránka',
        'contact.projectType.chatbot': 'Chatbot pro můj web',
