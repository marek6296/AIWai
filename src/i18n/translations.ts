...
export const translations: Record<Lang, Record<string, string>> = {
    en: {
        ...
        'whyUs.process.0.title': 'Intelligence Mapping',
        'whyUs.process.0.description': 'We deep-dive into your data and workflows to identify the most impactful AI opportunities.',
        'whyUs.process.1.title': 'Neural Engineering',
        'whyUs.process.1.description': 'We architect custom neural bridges and autonomous agents tailored to your specific ecosystem.',
        'whyUs.process.2.title': 'Autonomous Growth',
        'whyUs.process.2.description': 'Seamless deployment with continuous AI optimization to ensure scalable business expansion.',
    ...
    sk: {
        ...
        'whyUs.process.0.title': 'Mapovanie Inteligencie',
        'whyUs.process.0.description': 'Hĺbková analýza vašich firemných dát a procesov pre identifikáciu kľúčových AI príležitostí.',
        'whyUs.process.1.title': 'Neurálne Inžinierstvo',
        'whyUs.process.1.description': 'Navrhujeme vlastné neurálne prepojenia a autonómnych agentov prispôsobených vášmu ekosystému.',
        'whyUs.process.2.title': 'Autonómny Rast',
        'whyUs.process.2.description': 'Plynulé nasadenie s neustálou AI optimalizáciou pre inteligentné a škálovateľné napredovanie.',
    ...
    cs: {
        ...
        'whyUs.process.0.title': 'Mapování Inteligence',
        'whyUs.process.0.description': 'Hloubková analýza vašich firemních dat a procesů pro identifikaci klíčových AI příležitostí.',
        'whyUs.process.1.title': 'Neurální Inženýrství',
        'whyUs.process.1.description': 'Navrhujeme vlastní neurální propojení a autonomní agenty přizpůsobené vašemu ekosystému.',
        'whyUs.process.2.title': 'Autonomní Růst',
        'whyUs.process.2.description': 'Plynulé nasazení s neustálou AI optimalizací pro inteligentní a škálovatelné napředování.',
