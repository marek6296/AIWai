...
export default function SluzbyClient() {
    ...
    return (
        <main className="relative min-h-screen bg-char text-cream selection:bg-gold/30 selection:text-cream">
            {/* HERO — fullscreen ───────────────────────────────────────── */}
            <section className="relative flex min-h-screen min-h-[100svh] items-start md:items-center overflow-hidden border-b border-cream/[0.07]">
                <SectionBackground variant="soft" />
                <FloatingServiceIcons />
                <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-48 pb-32 md:py-40">
